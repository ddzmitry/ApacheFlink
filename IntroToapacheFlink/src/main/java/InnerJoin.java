...
//./bin/flink run -c InnerJoin ~/FlinkProject/target/ApacheFlinkIntro-1.0-SNAPSHOT.jar --input1 ~/FlinkProject/person.txt --input2 ~/FlinkProject/location.txt --output ~/InnerJoin
...
public class InnerJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.join(locationSet, JoinOperatorBase.JoinHint.REPARTITION_SORT_MERGE).where(0).equalTo(0)
