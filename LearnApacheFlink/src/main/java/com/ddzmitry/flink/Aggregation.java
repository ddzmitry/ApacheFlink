...
public class Aggregation
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<String> data = env.readTextFile("/root/FlinkUpdated/src/datasets/avg1");
        ...
        mapped.keyBy(0).sum(3).writeAsText("/root/FlinkUpdated/src/dataout/out1");

        mapped.keyBy(0).min(3).writeAsText("/root/FlinkUpdated/src/dataout/out2");

        mapped.keyBy(0).minBy(3).writeAsText("/root/FlinkUpdated/src/dataout/out3");

        mapped.keyBy(0).max(3).writeAsText("/root/FlinkUpdated/src/dataout/out4");

        mapped.keyBy(0).maxBy(3).writeAsText("/root/FlinkUpdated/src/dataout/out5");
        // execute program
