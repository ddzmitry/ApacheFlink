    ...
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Long> sum = data.map(new MapFunction<String, Tuple2<Long, String>>()
        {
            public Tuple2<Long, String> map(String s)
            {
                ...
                .keyBy(0)
//                Using statefull function
                .flatMap(new StatefulMap());
        sum.writeAsText("C:\\Users\\ddzmi\\Desktop\\Tutoring Trilogy\\ApacheFlink\\LearnApacheFlink\\src\\dataout\\valueState");
    ...
    {
//        RichFlatMapFunction has methods open(),close(),getRuntimeContext(),setRuntimeContext()
...
//            Update state with new values (Like callback)
            count.update(currCount);
            sum.update(currSum);

//            once count is 10 it will flush the state and output data
//            works like a timer
            if (currCount >= 10)
            {
