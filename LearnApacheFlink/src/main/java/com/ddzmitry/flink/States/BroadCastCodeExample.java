package com.ddzmitry.flink.States;
...
public class BroadCastCodeExample
{
...
//		Concats small and big data
		BroadcastStream<String> excludeEmpBroadcast =	excludeEmp.broadcast(excludeEmpDescriptor);
		
		DataStream<Tuple2<String, Integer>> employees = env.readTextFile("C:\\Users\\ddzmi\\Desktop\\Tutoring Trilogy\\ApacheFlink\\LearnApacheFlink\\src\\datasets\\broadcast.txt")
		...
		employees.writeAsText("C:\\Users\\ddzmi\\Desktop\\Tutoring Trilogy\\ApacheFlink\\LearnApacheFlink\\src\\dataout\\bd_out");
