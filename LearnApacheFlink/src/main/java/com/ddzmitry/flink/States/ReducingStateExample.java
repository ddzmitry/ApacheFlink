...
{
//    Reducing State keeps a single value in it and that value is the sum of all elements in state added in state so far
    public static void main(String[] args) throws Exception
    {
        ...
        sum.writeAsText("C:\\Users\\ddzmi\\Desktop\\Tutoring Trilogy\\ApacheFlink\\LearnApacheFlink\\src\\dataout\\reducingState");
