...
public class SplitDemo
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<String> text = env.readTextFile("/root/FlinkUpdated/src/datasets/oddeven");
...
//                            Will be as label (even , 2) (odd ,3)
        ...
        evenData.writeAsText("/root/FlinkUpdated/src/dataout/even");
        oddData.writeAsText("/root/FlinkUpdated/src/dataout/odd");
