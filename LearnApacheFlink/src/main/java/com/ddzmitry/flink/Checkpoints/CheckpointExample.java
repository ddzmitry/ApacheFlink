package com.ddzmitry.flink.Checkpoints;
...
public class CheckpointExample
{
    public static void main(String[] args) throws Exception
    {
        ...
        sum.writeAsText("C:\\Users\\ddzmi\\Desktop\\Tutoring Trilogy\\ApacheFlink\\LearnApacheFlink\\src\\dataout\\checkpoint");
    ...
    public static class StatefulMap extends RichFlatMapFunction<Tuple2<Long, String>, Long>
    {
        ...
        public void flatMap(Tuple2<Long, String> input, Collector<Long> out)throws Exception
        {
            ...
            currentCount += 1;
            currentSum = currentSum + Long.parseLong(input.f1);
