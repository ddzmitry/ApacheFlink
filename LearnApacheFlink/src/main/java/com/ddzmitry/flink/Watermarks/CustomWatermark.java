package com.ddzmitry.flink.Watermarks;
...
public class CustomWatermark {
    public static void main(String[] args) throws Exception {
        ...
        sum.writeAsText("C:\\Users\\ddzmi\\Desktop\\Tutoring Trilogy\\ApacheFlink\\LearnApacheFlink\\src\\WatermarkExample");
...
//        It will filter out elements to SideOut(late records) if the timestamp of recors is less then 3.5 seconds
...
//            To get current timpestamp of element
            long timestamp = element.f0;
            System.out.println(String.format("Timestamp of record is %s",timestamp));
            currentMaxTimestamp = Math.max(timestamp, currentMaxTimestamp);
            System.out.println(String.format("Current Timestamp is %s",currentMaxTimestamp));
            return timestamp;
        }
